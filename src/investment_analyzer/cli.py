"""V12.54 command-line entry point for the multi-asset investment analyzer."""
...
def run_cli(ticker:str,pipeline:AnalysisPipeline)->int:
    ...
    print(format_decision_report(context)); print(render_actionable_layer(context)); return 0

def main(pipeline:AnalysisPipeline|None=None)->int:
    args=build_parser().parse_args()
    ticker=(args.ticker or input('Ingrese el activo: ').strip()).upper()
